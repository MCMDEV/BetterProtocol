...
public class EncodingInjector extends BukkitInjector {
    ...
    public EncodingInjector(AbstractProtocolRegistry protocolRegistry, CommonEventBus<Player> eventBus) {
        super("better_protocol_outgoing_listener", "better_protocol_encoder", protocolRegistry, eventBus);
    }
